...
console.log("First _IDEAL_BLOCK_TIME_SECONDS:", _IDEAL_BLOCK_TIME_SECONDS);
  ...
  el_safe('#Liquidity').innerHTML += "& <b>" + (liq0xx).toFixed(0) + " </b> 0xBitcoin";
...
//GET THE FUCKING RATIO BABY
  el_safe('#CurrentRewardEra').innerHTML += " <span style='font-size:0.8em;'>(next era: ~" + secondsToReadableTime(rewards_blocks_remaining_in_era * _IDEAL_BLOCK_TIME_SECONDS * 2.08 / totalOwed1) +")</div>";
