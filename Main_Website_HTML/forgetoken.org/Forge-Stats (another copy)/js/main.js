...
/* intrinsic values */
/* intrinsic values */
const _SECONDS_PER_ETH_BLOCK = 5/2;
...
//GET THE FUCKING RATIO BABY
  el_safe('#CurrentRewardEra').innerHTML += " <span style='font-size:0.8em;'>(next era: ~" + secondsToReadableTime(rewards_blocks_remaining_in_era * _IDEAL_BLOCK_TIME_SECONDS * 1 / rad) +")</div>";
...
function updateThirdPartyAPIs() {
  ...
  $.getJSON('https://raw.githubusercontent.com/CrazyCaptian/Forge-Main/main/holdersandtran.html',
    function(data) {
