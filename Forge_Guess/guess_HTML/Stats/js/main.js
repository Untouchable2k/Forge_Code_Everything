...
const _CONTRACT_ADDRESS = "0xbB9C55d014Ce22782374180f7525B0B05Eb152a2";
...
var eth = new Eth(new Eth.HttpProvider("https://polygon-mainnet.g.alchemy.com/v2/c72TXAwpsKRgCm4AthFzyXfe05_1AKpp"));
...
console.log("T2: ");
 ...
 var innerhtml_buffer = '<tr><th>Time (Approx)</th><th>Polygon Block #</th>'
  ...
  eth.getLogs({
    fromBlock: last_reward_eth_block - 100000,
    toBlock: last_reward_eth_block,
    address: _CONTRACT_ADDRESS,
