...
const tokenBalance5 = useTokenBalance(weth, guess);
...
msgToo = "Currently too many bets placed and it will affect payouts, please wait for bets to settle"
  ...
  if(test >= 0 ){
    ...
    profitBetsMsg = "Your profit on Guessing Game is " + profitBets2.toFixed(2) + " Forge"
 ...
 if(tokenBalance5 !== nothing && tokenBalance !== nothing ){
  ...
  if(totalProfit !== nothing){
    ...
    var msgString = "Your investment Profits: "+ readable.toFixed(2) + " Forge"
     msgProfit = msgString
...
var unstakeButMsg = parseFloat((amount2).toString()).toFixed(3)
 ...
 b1 = <Button
  ...
  if( "0xbB9C55d014Ce22782374180f7525B0B05Eb152a2" === tokenAddress){
