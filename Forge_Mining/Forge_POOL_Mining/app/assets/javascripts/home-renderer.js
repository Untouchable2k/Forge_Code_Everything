...
export default class HomeRenderer {
    ...
    init( )
    {
      ...
      //  self.accountListData.minerAccountData = data;
        ...
        data.etherscanMintingURL = "https://bscscan.com/address/"+data.mintingAddress.toString();
        data.etherscanPaymentURL = "https://bscscan.com/address/"+data.paymentAddress.toString();
