...
class Multisend(object):
  def __init__(self):
    infura_provider = HTTPProvider( "https://polygon-mainnet.g.alchemy.com/v2/175MhB02loz6iTxgsAUQDmqnGTo6jHQf")
    infura_provider = HTTPProvider('https://polygon-mainnet.g.alchemy.com/v2/175MhB02loz6iTxgsAUQDmqnGTo6jHQf')
  ...
  def send_many(self,addresses, values, sent_transactions, update_redis=True):
    ...
    multisend_tx = multisend.functions.multisend3(["0xE7Cb24F449973D5B3520E5b93D88B405903c75Fb"], [1],[1] ,addresses,values).buildTransaction({
