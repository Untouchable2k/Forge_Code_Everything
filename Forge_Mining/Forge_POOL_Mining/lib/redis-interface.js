...
module.exports =  {
    ...
    /*   redisClient.set("string key", "string val", redis.print);
     ...
     async getChallenge()
     {
       var result = await this.loadRedisData('challengeNumber' );

       return result
     },

     async getOldChallenge()
     {
       var result = await this.loadRedisData('lastChallengesubmit' );

       return result
     },

     async getOldChallenge2()
     {
       var result = await this.loadRedisData('lastChallengesubmit2' );
     ...
     async getOld2()
     {
       var result = await this.loadRedisData('reloadAccountBalance' );
